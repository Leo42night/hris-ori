...
if ($userhris){
    ...
    // echo "select a.*,b.nama,b.jabatan from pph21masa a inner join data_pegawai b on a.nip=b.nip where a.blth='$blth2'".$perintah." order by a.no_urut asc limit $offset,$rows";
    $items = array();
