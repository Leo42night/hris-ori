...
if ($userhris){
    ...
    if(isset($_FILES['file_templatemsnikah'])){
        if(is_uploaded_file($_FILES['file_templatemsnikah']['tmp_name'])){
            $uploadFile = $_FILES['file_templatemsnikah'];                 
            ...
            $nama_file2 = $userhris."-msnikah-".date('YmdHis').".$fileExt";
    ...
    if ($nama_file2!=""){
        ...
        foreach ($rows as $key => $value) {
            ...
            $sql = "insert into m_status_nikah(label) values('$label')";
