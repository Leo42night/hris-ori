...
if ($userhris){
    ...
    if(isset($_FILES['file_templatemkewarganegaraan'])){
        if(is_uploaded_file($_FILES['file_templatemkewarganegaraan']['tmp_name'])){
            $uploadFile = $_FILES['file_templatemkewarganegaraan'];                 
            ...
            $nama_file2 = $userhris."-mkewarganegaraan-".date('YmdHis').".$fileExt";
    ...
    if ($nama_file2!=""){
        ...
        foreach ($rows as $key => $value) {
            ...
            $sql = "insert into m_status_kewarganegaraan(label) values('$label')";
