...
if ($userhris){
    ...
    if(isset($_FILES['file_templatemspend'])){
        if(is_uploaded_file($_FILES['file_templatemspend']['tmp_name'])){
            $uploadFile = $_FILES['file_templatemspend'];                 
            ...
            $nama_file2 = $userhris."-mspend-".date('YmdHis').".$fileExt";
