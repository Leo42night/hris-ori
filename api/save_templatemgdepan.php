...
if ($userhris){
    ...
    if(isset($_FILES['file_templatemgdepan'])){
        if(is_uploaded_file($_FILES['file_templatemgdepan']['tmp_name'])){
            $uploadFile = $_FILES['file_templatemgdepan'];                 
            ...
            $nama_file2 = $userhris."-mgdepan-".date('YmdHis').".$fileExt";
    ...
    if ($nama_file2!=""){
        ...
        foreach ($rows as $key => $value) {
            ...
            $sql = "insert into m_gelar_depan(label) values('$label')";
