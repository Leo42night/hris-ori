...
if ($userhris){
    ...
    if(isset($_FILES['file_templatemgrade'])){
        if(is_uploaded_file($_FILES['file_templatemgrade']['tmp_name'])){
            $uploadFile = $_FILES['file_templatemgrade'];                 
            ...
            $nama_file2 = $userhris."-mgrade-".date('YmdHis').".$fileExt";
    ...
    if ($nama_file2!=""){
        ...
        foreach ($rows as $key => $value) {
            ...
            $sql = "insert into m_grade(label) values('$label')";
