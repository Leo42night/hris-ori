...
if ($userhris){
    ...
    if(isset($_FILES['file_templatempekerjaan'])){
        if(is_uploaded_file($_FILES['file_templatempekerjaan']['tmp_name'])){
            $uploadFile = $_FILES['file_templatempekerjaan'];                 
            ...
            $nama_file2 = $userhris."-mpekerjaan-".date('YmdHis').".$fileExt";
    ...
    if ($nama_file2!=""){
        ...
        foreach ($rows as $key => $value) {
            ...
            $sql = "insert into m_pekerjaan(label) values('$label')";
