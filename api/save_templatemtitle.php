...
if ($userhris){
    ...
    if(isset($_FILES['file_templatemtitle'])){
        if(is_uploaded_file($_FILES['file_templatemtitle']['tmp_name'])){
            $uploadFile = $_FILES['file_templatemtitle'];                 
            ...
            $nama_file2 = $userhris."-mtitle-".date('YmdHis').".$fileExt";
