...
require_once $_SERVER['DOCUMENT_ROOT'] . "/hris-ori/database/koneksi.php";
    ...
    $tahun_ini = date("Y");
    $tanggal1 = isset($_POST['tgl_approve1cari']) ? $_POST['tgl_approve1cari'] : "";
    $tanggal2 = isset($_POST['tgl_approve2cari']) ? $_POST['tgl_approve2cari'] : "";
    
    $offset = ($page-1)*$rows;
    $result = array();
    $perintah = "";    
    if($tanggal1!="" && $tanggal2!="" && $tanggal2>=$tanggal1){
        $perintah .= " and tgl_approvebayar>='$tanggal1' and tgl_approvebayar<='$tanggal2'";
    }
    ...
    $items = array();
    $rs = mysqli_query($koneksi,"select * from sppd1 where approvebayar='2' and bayar='0'".$perintah."  order by tgl_approvebayar asc limit $offset,$rows");
    while ($hasil = mysqli_fetch_array($rs)) {
        ...
        $datanya = array();
        $datanya["idsiapbayar"] = $id;
        $datanya["idsppdsiapbayar"] = $idsppd;
        $datanya["tanggalsiapbayar"] = $tanggal;
        $datanya["tanggal2siapbayar"] = $tanggal2;
        $datanya["tingkat_sppdsiapbayar"] = $tingkat_sppd;
        $datanya["tingkat_sppd2siapbayar"] = $tingkat_sppd2;
        $datanya["jenis_sppdsiapbayar"] = $jenis_sppd;
        $datanya["jenis_sppd2siapbayar"] = $jenis_sppd2;
        $datanya["level_sppdsiapbayar"] = $level_sppd;
        $datanya["level_sppd2siapbayar"] = $level_sppd2;
        $datanya["no_sppdsiapbayar"] = $no_sppd;
        $datanya["nipsiapbayar"] = $nip;
        $datanya["namasiapbayar"] = $nama;
        $datanya["gradesiapbayar"] = $grade;
        $datanya["jabatansiapbayar"] = $jabatan;
        $datanya["maksudsiapbayar"] = $maksud;
        $datanya["agendasiapbayar"] = $agenda;
        $datanya["kedudukansiapbayar"] = $kedudukan;
        $datanya["tujuansiapbayar"] = $tujuan;
        $datanya["jaraksiapbayar"] = $jarak;
        $datanya["transportasisiapbayar"] = $transportasi;
        $datanya["tgl_awalsiapbayar"] = $tgl_awal;
        $datanya["tgl_awal2siapbayar"] = $tgl_awal2;
        $datanya["tgl_akhirsiapbayar"] = $tgl_akhir;
        $datanya["tgl_akhir2siapbayar"] = $tgl_akhir2;
        $datanya["harisiapbayar"] = $hari;
        $datanya["jenis_tujuansiapbayar"] = $jenis_tujuan;
        $datanya["approve1siapbayar"] = $approve1;
        $datanya["approval1siapbayar"] = $approval1;
        $datanya["jabatan_approval1siapbayar"] = $jabatan_approval1;
        $datanya["tgl_approve1siapbayar"] = $tgl_approve1;
        $datanya["tgl_approve12siapbayar"] = $tgl_approve12;
        $datanya["alasan_reject1siapbayar"] = $alasan_reject1;
        $datanya["approve2siapbayar"] = $approve2;
        $datanya["approval2siapbayar"] = $approval2;
        $datanya["jabatan_approval2siapbayar"] = $jabatan_approval2;
        $datanya["tgl_approve2siapbayar"] = $tgl_approve2;
        $datanya["tgl_approve22siapbayar"] = $tgl_approve22;
        $datanya["alasan_reject2siapbayar"] = $alasan_reject2;
        $datanya["validasi_biayasiapbayar"] = $validasi_biaya;
        $datanya["tgl_validasisiapbayar"] = $tgl_validasi;
        $datanya["tgl_validasi2siapbayar"] = $tgl_validasi2;
        $datanya["approvesdmsiapbayar"] = $approvesdm;
        $datanya["approvalsdmsiapbayar"] = $approvalsdm;
        $datanya["jabatan_approvalsdmsiapbayar"] = $jabatan_approvalsdm;
        $datanya["tgl_approvesdmsiapbayar"] = $tgl_approvesdm;
        $datanya["tgl_approve2sdmsiapbayar"] = $tgl_approvesdm2;
        $datanya["alasan_rejectsdmsiapbayar"] = $alasan_rejectsdm;
        $datanya["approvebayarsiapbayar"] = $approvebayar;
        $datanya["approvalbayarsiapbayar"] = $approvalbayar;
        $datanya["jabatan_approvalbayarsiapbayar"] = $jabatan_approvalbayar;
        $datanya["tgl_approvebayarsiapbayar"] = $tgl_approvebayar;
        $datanya["tgl_approvebayar2siapbayar"] = $tgl_approvebayar2;
        $datanya["alasan_rejectbayarsiapbayar"] = $alasan_rejectbayar;
        $datanya["bayarsiapbayar"] = $bayar;
        $datanya["tgl_bayarsiapbayar"] = $tgl_bayar;
        $datanya["tgl_bayar2siapbayar"] = $tgl_bayar2;
        $datanya["totalsiapbayar"] = $total;
        $datanya["total2siapbayar"] = number_format($total,0,',','.');
        $datanya["restitusisiapbayar"] = $restitusi;
        $datanya["restitusi2siapbayar"] = number_format($restitusi,0,',','.');
        $datanya["timelinesiapbayar"] = $timeline;
