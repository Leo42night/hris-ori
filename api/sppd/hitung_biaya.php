...
if ($userhris){
    ...
    if($jumlah_biaya==1){
        ...
        $sql .= "nilai_anak,total_anak,berat_pengepakan,nilai_pengepakan,total_pengepakan,";
        // $sql .= "kurs_ln,transporta_ln,transportb_ln,transportc_ln,transportd_ln,transportasi_lokal_ln,airport_tax_ln,hari_lumpsum,";
        // $sql .= "nilai_lumpsum,hari_pegawai_ln,persen_pegawai_ln,nilai_pegawai_ln,hari_keluarga_ln,persen_keluarga_ln,";
        $sql .= "nilai_keluarga_ln,hari_pengantar_ln,persen_pengantar_ln,nilai_pengantar_ln,baju_hangat_ln,total)";
        // $sql .= " where idsppd='$idsppd'";
        ...
        $sql .= "'$nilai_pengantar','$total_pengantar','$hari_suamiistri','$persen_suamiistri',";
        $sql .= "'$nilai_suamiistri','$total_suamiistri','$hari_anak','$persen_anak',";
        $sql .= "'$nilai_anak','$total_anak','0','0','$total_pengepakan',";
        // $sql .= "'0','0','0','0','0','0','0','0',";
        // $sql .= "'0','0','0','0','0','0',";
        $sql .= "'0','0','0','0','0','$total')";
        // $sql .= " where idsppd='$idsppd'";   
