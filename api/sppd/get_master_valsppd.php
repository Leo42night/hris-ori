...
if ($userhris){
    ...
    $tahun_ini = date("Y");
    $status2 = isset($_POST['statusvalsppdcari']) ? $_POST['statusvalsppdcari'] : "0";
    $nip2 = isset($_POST['nipvalsppdcari']) ? $_POST['nipvalsppdcari'] : "";
    
    $offset = ($page-1)*$rows;
    $result = array();
    $perintah = "";    
    if($status2!="9"){
        $perintah .= " and validasi_biaya='$status2'";
    }
    if($nip2!=""){
    ...
    while ($hasil = mysqli_fetch_array($rs)) {
        ...
        $datanya = array();
        $datanya["idvalsppd"] = $id;
        $datanya["idsppdvalsppd"] = $idsppd;
        $datanya["tanggalvalsppd"] = $tanggal;
        $datanya["tanggal2valsppd"] = $tanggal2;
        $datanya["tingkat_sppdvalsppd"] = $tingkat_sppd;
        $datanya["tingkat_sppd2valsppd"] = $tingkat_sppd2;
        $datanya["jenis_sppdvalsppd"] = $jenis_sppd;
        $datanya["jenis_sppd2valsppd"] = $jenis_sppd2;
        $datanya["level_sppdvalsppd"] = $level_sppd;
        $datanya["level_sppd2valsppd"] = $level_sppd2;
        $datanya["no_sppdvalsppd"] = $no_sppd;
        $datanya["nipvalsppd"] = $nip;
        $datanya["namavalsppd"] = $nama;
        $datanya["gradevalsppd"] = $grade;
        $datanya["jabatanvalsppd"] = $jabatan;
        $datanya["maksudvalsppd"] = $maksud;
        $datanya["agendavalsppd"] = $agenda;
        $datanya["kedudukanvalsppd"] = $kedudukan;
        $datanya["tujuanvalsppd"] = $tujuan;
        $datanya["jarakvalsppd"] = $jarak;
        $datanya["transportasivalsppd"] = $transportasi;
        $datanya["tgl_awalvalsppd"] = $tgl_awal;
        $datanya["tgl_awal2valsppd"] = $tgl_awal2;
        $datanya["tgl_akhirvalsppd"] = $tgl_akhir;
        $datanya["tgl_akhir2valsppd"] = $tgl_akhir2;
        $datanya["harivalsppd"] = $hari;
        $datanya["jenis_tujuanvalsppd"] = $jenis_tujuan;
        $datanya["approve1valsppd"] = $approve1;
        $datanya["approval1valsppd"] = $approval1;
        $datanya["jabatan_approval1valsppd"] = $jabatan_approval1;
        $datanya["tgl_approve1valsppd"] = $tgl_approve1;
        $datanya["tgl_approve12valsppd"] = $tgl_approve12;
        $datanya["alasan_reject1valsppd"] = $alasan_reject1;
        $datanya["approve2valsppd"] = $approve2;
        $datanya["approval2valsppd"] = $approval2;
        $datanya["jabatan_approval2valsppd"] = $jabatan_approval2;
        $datanya["tgl_approve2valsppd"] = $tgl_approve2;
        $datanya["tgl_approve22valsppd"] = $tgl_approve22;
        $datanya["alasan_reject2valsppd"] = $alasan_reject2;
        $datanya["validasi_biayavalsppd"] = $validasi_biaya;
        $datanya["tgl_validasivalsppd"] = $tgl_validasi;
        $datanya["tgl_validasi2valsppd"] = $tgl_validasi2;
        $datanya["approvesdmvalsppd"] = $approvesdm;
        $datanya["approvalsdmvalsppd"] = $approvalsdm;
        $datanya["jabatan_approvalsdmvalsppd"] = $jabatan_approvalsdm;
        $datanya["tgl_approvesdmvalsppd"] = $tgl_approvesdm;
        $datanya["tgl_approve2sdmvalsppd"] = $tgl_approvesdm2;
        $datanya["alasan_rejectsdmvalsppd"] = $alasan_rejectsdm;
        $datanya["approvebayarvalsppd"] = $approvebayar;
        $datanya["approvalbayarvalsppd"] = $approvalbayar;
        $datanya["jabatan_approvalbayarvalsppd"] = $jabatan_approvalbayar;
        $datanya["tgl_approvebayarvalsppd"] = $tgl_approvebayar;
        $datanya["tgl_approvebayar2valsppd"] = $tgl_approvebayar2;
        $datanya["alasan_rejectbayarvalsppd"] = $alasan_rejectbayar;
        $datanya["bayarvalsppd"] = $bayar;
        $datanya["tgl_bayarvalsppd"] = $tgl_bayar;
        $datanya["tgl_bayar2valsppd"] = $tgl_bayar2;
        $datanya["totalvalsppd"] = $total;
        $datanya["total2valsppd"] = number_format($total,0,',','.');
        $datanya["restitusivalsppd"] = $restitusi;
        $datanya["restitusi2valsppd"] = number_format($restitusi,0,',','.');
        $datanya["timelinevalsppd"] = $timeline;
