...
if ($userhris){
    ...
    if(isset($_FILES['file_templatemgdarah'])){
        if(is_uploaded_file($_FILES['file_templatemgdarah']['tmp_name'])){
            $uploadFile = $_FILES['file_templatemgdarah'];                 
            ...
            $nama_file2 = $userhris."-mgdarah-".date('YmdHis').".$fileExt";
    ...
    if ($nama_file2!=""){
        ...
        foreach ($rows as $key => $value) {
            ...
            $sql = "insert into m_gol_darah(label) values('$label')";
