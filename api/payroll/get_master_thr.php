...
if ($userhris){
    ...
    // echo "select a.*,b.nama,b.nama_bank,b.no_rekening,b.nama_rekening from thr a left join data_pegawai b on a.nip=b.nip where a.tahun='$tahun2'".$perintah." order by id asc limit $offset,$rows";
