    ...
    if ($nama_file2!=""){
        ...
        foreach ($rows as $key => $value) {
            ...
            if($nip!=="" && $semester<>'' && $semester>=1 && $semester<=2 && $p31>0){
                ...
                $sql = "insert into iks(blth,tahun,semester,nip,nipsemester,p31,tgl_proses,petugas)";
                $sql .= " values('$blth','$tahun','$semester','$nip','$nipsemester','$p31','$tgl_proses','$userhris')";
        ...
        echo json_encode(array('successMsg'=>'Sukses : '.$hitungSukses.', Gagal : '.$hitungGagal." ".$pesan));
    } else {
        //echo json_encode(array('errorMsg'=>'Gagal'));
        echo json_encode(array('successMsg'=>'Gagal upload file'));
