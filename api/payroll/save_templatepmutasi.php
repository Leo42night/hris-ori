...
if ($userhris){
    ...
    if(isset($_FILES['file_templatepmutasi'])){
        if(is_uploaded_file($_FILES['file_templatepmutasi']['tmp_name'])){
            $uploadFile = $_FILES['file_templatepmutasi'];                 
            ...
            $nama_file2 = $userhris."-pmutasi-".date('YmdHis').".$fileExt";
