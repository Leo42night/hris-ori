...
$sheet->setCellValue('A4', 'DAFTAR POTONGAN HONORARIUM BULAN '.strtoupper(TanggalIndo3($blth2)));
...
header('Content-Disposition: attachment; filename="Potongan Honorarium.xlsx"'); // Set nama file excel nya
