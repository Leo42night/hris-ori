...
if ($userhris){
    ...
    if(isset($_FILES['file_templatemjkelamin'])){
        if(is_uploaded_file($_FILES['file_templatemjkelamin']['tmp_name'])){
            $uploadFile = $_FILES['file_templatemjkelamin'];                 
            ...
            $nama_file2 = $userhris."-mjkelamin-".date('YmdHis').".$fileExt";
    ...
    if ($nama_file2!=""){
        ...
        foreach ($rows as $key => $value) {
            ...
            $sql = "insert into m_jenis_kelamin(label) values('$label')";
