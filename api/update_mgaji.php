...
if ($userhris){
    ...
    if($id>0){
        $sql = "insert into  master_gaji(nip,gaji_dasar,honorarium,honorer,tarif_grade,tunjangan_posisi,tunjangan_kemahalan,tunjangan_perumahan,tunjangan_transportasi,bantuan_pulsa,dplk_persero,dplk_simponi_pr";
        ...
        $sql .= " values('$nip','$gaji_dasar','$honorarium','$honorer','$tarif_grade','$tunjangan_posisi','$tunjangan_kemahalan','$tunjangan_perumahan','$tunjangan_transportasi','$bantuan_pulsa','$dplk_persero','$dplk_simponi_pr";
        $sql .= "','$nama_tunjangan1','$tunjangan1','$nama_tunjangan2','$tunjangan2','$nama_tunjangan3','$tunjangan3','$nama_tunjangan4','$tunjangan4";
        $sql .= "','$bpjs_tk_pp','$bpjs_tk_kp','$bpjs_tk_kkp','$bpjs_tk_htp','$bpjs_tk_jhtk','$bpjs_tk_pk','$rp_bpjs_tk_pp','$rp_bpjs_tk_kp','$rp_bpjs_tk_kkp','$rp_bpjs_tk_htp','$rp_bpjs_tk_jhtk','$rp_bpjs_tk_pk','$bpjs_kes_pp','$bpjs_kes_pk";
        $sql .= "','$pot_koperasi','$pot_bazis','$dplk_simponi','$pot_dplk_pribadi','$cop_kendaraan','$iuran_peserta','$brpr','$sewa_mess','$qurban','$arisan";
        $sql .= "','$nama_potongan1','$potongan1','$nama_potongan2','$potongan2','$nama_potongan3','$potongan3','$nama_potongan4','$potongan4')";
    } else {
        $sql = "update master_gaji set gaji_dasar='$gaji_dasar',honorarium='$honorarium',honorer='$honorer',tarif_grade='$tarif_grade',tunjangan_posisi='$tunjangan_posisi',tunjangan_kemahalan='$tunjangan_kemahalan',tunjangan_perumahan='$tunjangan_perumahan',tunjangan_transportasi='$tunjangan_transportasi',bantuan_pulsa='$bantuan_pulsa',dplk_persero='$dplk_persero',dplk_simponi_pr='$dplk_simponi_pr";
    ...
    if ($result){
    	...
    	echo json_encode(array('errorMsg'=>mysqli_error($koneksi2)));
    }
}    
?>