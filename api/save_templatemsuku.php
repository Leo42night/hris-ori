...
if ($userhris){
    ...
    if(isset($_FILES['file_templatemsuku'])){
        if(is_uploaded_file($_FILES['file_templatemsuku']['tmp_name'])){
            $uploadFile = $_FILES['file_templatemsuku'];                 
            ...
            $nama_file2 = $userhris."-msuku-".date('YmdHis').".$fileExt";
    ...
    if ($nama_file2!=""){
        ...
        foreach ($rows as $key => $value) {
            ...
            $sql = "insert into m_suku(label) values('$label')";
