...
if ($userhris){
    ...
    if(isset($_FILES['file_templatemjalamat'])){
        if(is_uploaded_file($_FILES['file_templatemjalamat']['tmp_name'])){
            $uploadFile = $_FILES['file_templatemjalamat'];                 
            ...
            $nama_file2 = $userhris."-mjalamat-".date('YmdHis').".$fileExt";
    ...
    if ($nama_file2!=""){
        ...
        foreach ($rows as $key => $value) {
            ...
            $sql = "insert into m_jenis_alamat(label) values('$label')";
