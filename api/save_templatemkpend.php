...
if ($userhris){
    ...
    if(isset($_FILES['file_templatemkpend'])){
        if(is_uploaded_file($_FILES['file_templatemkpend']['tmp_name'])){
            $uploadFile = $_FILES['file_templatemkpend'];                 
            ...
            $nama_file2 = $userhris."-mkpend-".date('YmdHis').".$fileExt";
    ...
    if ($nama_file2!=""){
        ...
        foreach ($rows as $key => $value) {
            ...
            $sql = "insert into m_keterangan_pendidikan(label) values('$label')";
