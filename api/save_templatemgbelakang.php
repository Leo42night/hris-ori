...
if ($userhris){
    ...
    if(isset($_FILES['file_templatemgbelakang'])){
        if(is_uploaded_file($_FILES['file_templatemgbelakang']['tmp_name'])){
            $uploadFile = $_FILES['file_templatemgbelakang'];                 
            ...
            $nama_file2 = $userhris."-mgbelakang-".date('YmdHis').".$fileExt";
    ...
    if ($nama_file2!=""){
        ...
        foreach ($rows as $key => $value) {
            ...
            $sql = "insert into m_gelar_belakang(label) values('$label')";
