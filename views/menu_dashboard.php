<?php
// missing tabs view files: d_unit.php, d_status.php, d_level_jabatan.php, d_jenis_kelamin.php, d_jenjang_jabatan.php, d_pendidikan.php
session_start();
...
function has_child($id){
    global $koneksi; // Use global variables instead of re-including the file
...
if ($userhris){
    ...
    $rs = mysqli_query($koneksi,"select a.*,b.proses,b.lihat from nodes a inner join aksesuser b ON a.id=b.idmenu and b.username='$userhris' and (b.proses='1' or b.lihat='1') where a.grup='DASHBOARD' and a.parentId<>'' and a.parentId2='' order by a.urut,a.id asc");
    while ($hasil = mysqli_fetch_array($rs)) {
        ...
        $proses = $hasil['proses'];
        $lihat = $hasil['lihat'];
        $filter = $name."|dashboard/".$url."|".$proses."|".$lihat;
        ...
        if($cekdata>0){
            ...
            $items2 = array();
            $rs2 = mysqli_query($koneksi,"select a.*,b.proses,b.lihat from nodes a inner join aksesuser b ON a.id=b.idmenu and b.username='$userhris' where a.parentId2='$id' and a.parentId2<>'' order by a.urut,a.id asc");
            while ($hasil2 = mysqli_fetch_array($rs2)) {
                ...
                $lihat2 = $hasil2['lihat'];
                $filter2 = $name2."|dashboard/".$url2."|".$proses2."|".$lihat2;
