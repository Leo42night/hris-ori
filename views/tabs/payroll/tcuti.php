<?php
// similiar with views/tabs/cuti/tcuti.php
session_start();
...
if (!$userhris || ($akses_proses!="1" && $akses_view!="1")){
    ...
    <script type="text/javascript">                     
        ...
        function onSelectkelompoktcuticari(){
            ...
            var url1 = 'get_spktcuticari.php[not_found]?kelompok='+nilai1+'&kd_region='+nilai2+'&kd_cabang='+nilai3;
			//alert(url1);
        ...
        function onSelectregiontcuticari(){
            ...
            var nilai3 = $('#kd_cabangtcuticari').combobox('getValue');
            var url1 = 'get_spktcuticari.php[not_found]?kelompok='+nilai1+'&kd_region='+nilai2+'&kd_cabang='+nilai3;
            var url2 = 'get_cabangtcuticari.php[not_found]?kd_region='+nilai2;
			//alert(url1);
        ...
        function onSelectkelompoktcuti(){
            ...
            var url1 = 'get_spktcuti.php[not_found]?kelompok='+nilai1+'&kd_region='+nilai2+'&kd_cabang='+nilai3;
			//alert(url1);
        ...
        function onSelectregiontcuti(){
            ...
            var nilai3 = $('#kd_cabangtcuti').combobox('getValue');
            var url1 = 'get_spktcuti.php[not_found]?kelompok='+nilai1+'&kd_region='+nilai2+'&kd_cabang='+nilai3;
            var url2 = 'get_cabangtcuti.php[not_found]?kd_region='+nilai2;
        ...
        function onSelectregiontcuti2(){
            ...
            var url2 = 'get_cabangtcuti2.php[not_found]?kd_region='+nilai1;
        ...
        function onSelectprojecttcuti(){
            ...
            var url2 = 'get_unittcuti.php[not_found]?kd_project='+nilai1;
        ...
        function onSelectprojecttcuti2(){
            ...
            var url2 = 'get_unittcuti2.php[not_found]?kd_project='+nilai1;
    ...
    <script type="text/javascript">
    	...
    	function resettcuti(){
    		...
    		url = '<?=$foldernya;?>save_tcuti2.php[not_found]';
    	}
    	function savetcuti2(){
            //alert(url);
        ...
        function downloadtcuti(){
            var blthnya = $('#blthtcuticari').datebox('getValue');
            window.open("<?=$foldernya;?>download_tcutiroll.php[not_found]?blth="+blthnya,"_blank");
        }
        /*
    	function prosestcuti2(){
    		...
    		$('#fmtcuti2').form('clear');
            $("#blthtcuti2").datebox('setValue', blthnya);
    		url2 = 'save_tcuti2.php[not_found]';
    	}
    	function savetcuti2(){
