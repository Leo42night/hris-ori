...
if (!$userhris || ($akses_proses!="1" && $akses_view!="1")){
    ...
    <table id="dgproject" title="" class="easyui-datagrid" style="width:100%;height:100%"	
            url="<?=$foldernya;?>get_master_project.php" pageSize="20"        
    	...
    	<thead>
    		<tr>
                ...
                <th field="statusproject" width="120" align="center" halign="center">Status</th>
    		</tr>
    	</thead>
    </table>
    	...
    	<div id="tbproject" style="padding:3px">
            ...
            <tr>
                ...
                <td>
					...
					<a href="javascript:void(0)" class="easyui-linkbutton c1" iconCls="fa fa-download" plain="false" onclick="loadproject()" style="min-width:90px;">Load Project</a>
                </td>
            </tr>
            </table>
    	</div>                
    ...
    <script type="text/javascript">
    	...
    	function loadproject(){
            $.messager.confirm('Konfirmasi','Load project dari SAP?',function(r){
                if (r){
                    $.messager.progress({height:75, text:'Proses load data Project dari SAP...'});
                    $.post('<?=$foldernya;?>getprojectmanual.php',{},function(result){
                        //alert(result);
