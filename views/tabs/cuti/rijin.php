...
if (!$userhris || ($akses_proses!="1" && $akses_view!="1")){
	...
	<script type="text/javascript">                     
        ...
        */
        function onSelectkelompokrijincari(){
            ...
            var url1 = 'get_spkrijincari.php[not_found]?kelompok='+nilai1+'&kd_region='+nilai2+'&kd_cabang='+nilai3;
			/*
    ...
    <script type="text/javascript">
        ...
        function downloadabsensi(){
            ...
            window.open("download_rijin.php[not_found]?tanggal="+tanggalnya+"&kelompok="+kelompoknya+"&kd_region="+kd_regionnya+"&kd_cabang="+kd_cabangnya+"&kd_unit="+kd_unitnya+"&no_spk="+no_spknya,"_blank");
        } 
