...
if (!$userhris || ($akses_proses!="1" && $akses_view!="1")){
	...
	<script type="text/javascript">                     
        ...
        */
        function onSelectkelompokmcuticari(){
            ...
            var url1 = 'get_spkmcuticari.php[not_found]?kelompok='+nilai1+'&kd_region='+nilai2+'&kd_cabang='+nilai3;
			/*
    ...
    <script type="text/javascript">
        ...
        function addmcuti(){
            ...
            $("#evidenmcuti").attr('src', "");
            url = '<?= $foldernya;?>save_mcuti.php[not_found]';  
        } 
        function editmcuti(index){
    		...
    		if (row){
                ...
                url = '<?= $foldernya;?>update_mcuti.php[not_found]?id='+row.idmcuti;  
            }
        } 
    	function savemcuti(){
        ...
        function cetakabsensi(){
            ...
            //window.open("lapmcuti.php[not_found]?tanggal="+tanggalnya+"&kelompok="+kelompoknya+"&kd_region="+kd_regionnya+"&kd_cabang="+kd_cabangnya+"&kd_unit="+kd_unitnya+"&nip_nama="+nip_namanya,"_blank");
            window.open("lapmcuti.php[not_found]?tanggal="+tanggalnya+"&kelompok="+kelompoknya+"&kd_region="+kd_regionnya+"&kd_cabang="+kd_cabangnya+"&kd_unit="+kd_unitnya+"&no_spk="+no_spknya,"_blank");
        } 
        ...
        function downloadabsensi(){
			...
			var no_spknya = $('#no_spkmcuticari').textbox('getText');
            var tanggalnya = $('#tanggalmcuticari').datebox('getValue');
            window.open("download_mcuti.php[not_found]?tanggal="+tanggalnya+"&kelompok="+kelompoknya+"&kd_region="+kd_regionnya+"&kd_cabang="+kd_cabangnya+"&kd_unit="+kd_unitnya+"&no_spk="+no_spknya,"_blank");
        } 
