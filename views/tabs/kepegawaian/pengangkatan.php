...
if (!$userhris || ($akses_proses!="1" && $akses_view!="1")){
    ...
    <table id="dgpengangkatan" title="" class="easyui-datagrid" style="width:100%;height:100%"	
            url="<?=$foldernya;?>get_master_pengangkatan.php" pageSize="20"        
    ...
    <script type="text/javascript">
    	...
    	function editpengangkatan(index){
    		...
    		if (row){
                ...
                url = '<?=$foldernya;?>update_pengangkatan.php?id='+row.idpengangkatan;  
            }          
    	}
            ...
            $('#fmpengangkatan').form('submit',{
                ...
                success: function(result){
                    ...
                    if (result.errorMsg){
                        ...
                        $.post('<?=$foldernya;?>update_pengangkatan.php',{},function(result){},'json');
    	...
    	function destroypengangkatan(index){
    		...
    		if (row){
    			$.messager.confirm('Konfirmasi','Yakin menghapus data ini?',function(r){
    				if (r){
    					$.post('<?=$foldernya;?>destroy_pengangkatan.php',{id:row.idpengangkatan},function(result){
    						if (result.success){
    	...
    	function uploadtemplatepengangkatan(){
    		...
    		url = '<?=$foldernya;?>save_templatepengangkatan.php';
    	}
