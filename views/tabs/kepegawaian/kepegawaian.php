...
if (!$userhris || ($akses_proses!="1" && $akses_view!="1")){
    ...
    $viewspath = "views/tabs/kepegawaian/";
    ?>
    <script>
    ...
    <table id="dgpegawai" title="" class="easyui-datagrid" style="width:100%;height:100%"	
            url="<?=$foldernya;?>get_master_kepegawaian.php" pageSize="20"        
            ...
            <tr>
                <td>
                    ...
                    <input class="easyui-combobox"
                        ...
                        data-options=" 
                            url:'<?=$foldernya;?>get_keterangan_mutasi.php',                           
                            required:true,
                            method:'get',
                            valueField:'value',
                            textField:'text',
            ...
            <tr>
                <td>
                    ...
                    <input class="easyui-combobox"
                        ...
                        data-options=" 
                            ...
                            url:'<?=$foldernya;?>get_gelar_depan.php',                           
                            required:false,
                            method:'get',
                            valueField:'value',
                            textField:'text',
                ...
                <td>
                    ...
                    <input class="easyui-combobox"
                        ...
                        data-options=" 
                            onChange:changeknowas,
                            url:'<?=$foldernya;?>get_gelar_belakang.php',                           
                            required:false,
                            method:'get',
                            valueField:'value',
                            textField:'text',
            ...
            <tr>
                ...
                <td>
                    ...
                    <input class="easyui-combobox"
                        ...
                        style="padding: 2px; width: 100%;" 
                        data-options=" 
                            url:'<?=$foldernya;?>get_status_nikah.php',                           
                            required:true,
                            method:'get',
                            valueField:'value',
                            textField:'text',
            ...
            <tr>
                ...
                <td>
                    ...
                    <input class="easyui-combobox"
                        ...
                        style="padding: 2px; width: 100%;" 
                        data-options=" 
                            url:'<?=$foldernya;?>get_status_warganegara.php',                           
                            required:true,
                            method:'get',
                            valueField:'value',
                            textField:'text',
            ...
            <tr>
                <td>
                    ...
                    <input class="easyui-combobox"
                        ...
                        style="padding: 2px; width: 100%;" 
                        data-options=" 
                            url:'<?=$foldernya;?>get_gol_darah.php',                           
                            required:false,
                            method:'get',
                            valueField:'value',
                            textField:'text',
            ...
            <tr>
                <td colspan="3">
                    ...
                    <input class="easyui-combobox"
                        ...
                        style="padding: 2px; width: 100%;" 
                        data-options=" 
                            url:'<?=$foldernya;?>get_jenis_dplk.php',                           
                            required:false,
                            method:'get',
                            valueField:'value',
                            textField:'text',
            ...
            <tr>
                <td colspan="3">
                    ...
                    <input class="easyui-combobox"
                        ...
                        style="padding: 2px; width: 100%;" 
                        data-options=" 
                            url:'<?=$foldernya;?>get_status_integrasi.php',                           
                            required:true,
                            method:'get',
                            valueField:'value',
                            textField:'text',
    ...
    <script type="text/javascript">
    	...
    	function addpegawai(){
    		...
    		url = '<?=$foldernya;?>save_kepegawaian.php';
    	}
    	function editpegawai(index){
    		...
    		if (row){
                ...
                url = '<?=$foldernya;?>update_kepegawaian.php?id='+row.idpegawai;  
            }          
    	}
            ...
            $('#fmpegawai').form('submit',{
                ...
                success: function(result){
                    ...
                    if (result.errorMsg){
                        ...
                        $.post('<?=$foldernya;?>update_kepegawaian.php',{},function(result){},'json');
    	...
    	function destroypegawai(index){
    		...
    		if (row){
    			$.messager.confirm('Konfirmasi','Yakin menghapus data pegawai "'+row.nama_lengkappegawai+'"?',function(r){
    				if (r){
    					$.post('<?=$foldernya;?>destroy_kepegawaian.php',{id:row.idpegawai,nip:row.nippegawai},function(result){
    						if (result.success){
    	...
    	function detailpegawai(index){
    		...
    		if (row){
                ...
                if ($('#tt').tabs('exists','Riwayat Pegawai')){
                    ...
                    tab.panel('refresh', '<?=$viewspath;?>pegawai2.php?nip='+row.nippegawai+'&proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
                } else {
                    $('#tt').tabs('add',{
                        title: 'Riwayat Pegawai',
                        href: '<?=$viewspath;?>pegawai2.php?nip='+row.nippegawai+'&proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                        closable: true
                    });
                }
    		}
