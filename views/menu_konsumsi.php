...
if ($userhris){
    ...
    $rs = mysqli_query($koneksi,"select a.*,b.proses,b.lihat from nodes a left join aksesuser b ON a.id=b.idmenu and b.username='$userhris' and (b.proses='1' or b.lihat='1') where a.grup='KONSUMSI' and a.parentId<>'' and a.parentId2='' order by a.urut,a.id asc");
