...
if (!$userhris || ($akses_proses!="1" && $akses_view!="1")){
    ...
    <script type="text/javascript">                     
		...
		function carinip(){
            ...
            //alert(nip);
            $.post('cari_pemberhentian.php',{nip:nip},function(result){                
    ...
    <table id="dgpemberhentian" title="" class="easyui-datagrid" style="width:100%;height:100%"	
            url="get_master_pemberhentian.php" pageSize="20"        
    ...
    <script type="text/javascript">
    	...
    	function editpemberhentian(index){
    		...
    		if (row){
                ...
                $("#divnipcari").hide();
                url = 'update_pemberhentian.php?id='+row.idpemberhentian;  
            }          
    	}
            ...
            $('#fmpemberhentian').form('submit',{
                ...
                success: function(result){
                    ...
                    if (result.errorMsg){
                        ...
                        $.post('updatedata/update_pemberhentian.php',{},function(result){},'json');
    	...
    	function destroypemberhentian(index){
    		...
    		if (row){
    			$.messager.confirm('Konfirmasi','Yakin menghapus data ini?',function(r){
    				if (r){
    					$.post('destroy_pemberhentian.php',{id:row.idpemberhentian},function(result){
    						if (result.success){
    	...
    	function uploadtemplatepemberhentian(){
    		...
    		url = 'save_templatepemberhentian.php';
    	}
