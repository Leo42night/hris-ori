...
if ($userhris){    
    ...
    if($jwtToken!=""){
        ...
        $request -> setUrl($baseurl."/api/media-sosial/save");
        ...
        $i=1;
        $rs32 = mysqli_query($koneksi,"select * from r_medsos where status_edit='1' order by id asc");
            ...
            */
            ...
            $datanya .= '
                {
                    ...
                    "endDate": "'.$end_date.'",
                    "nip": "'.$nip.'",
                    "kodeJenisMediaSosial": "'.$jenis_medsos.'",
                    "idMediaSosial": "'.$id_medsos.'",
            ...
            try {
                ...
                if (200 == $response->getStatus()) {
                    ...
                    if($statusnya==true){
                        $sql2 = "update r_medsos set status_edit='0',tgl_edit='',user_edit='' where id=$id";
            ...
            $sql1 .= " values('r_medsos','$id','$tgl_edit','$user_edit','$hari_ini','$userhris','$status','$keterangan')";
