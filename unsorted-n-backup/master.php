    ...
    <script type="text/javascript">
        ...
        function addPanel1901(){			
            ...
            if ($('#tt4').tabs('exists','M-Title')){
                ...
                tab.panel('refresh', 'mtitle.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Title',
                    href: 'mtitle.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1902(){			
            ...
            if ($('#tt4').tabs('exists','M-Gelar Depan')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mgdepan.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Gelar Depan',
                    href: 'mgdepan.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1903(){			
            ...
            if ($('#tt4').tabs('exists','M-Gelar Belakang')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mgbelakang.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Gelar Belakang',
                    href: 'mgbelakang.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1904(){			
            ...
            if ($('#tt4').tabs('exists','M-Negara')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mnegara.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Negara',
                    href: 'mnegara.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1905(){			
            ...
            if ($('#tt4').tabs('exists','M-Jenis Kelamin')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mjkelamin.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Jenis Kelamin',
                    href: 'mjkelamin.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1906(){			
            ...
            if ($('#tt4').tabs('exists','M-Agama')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'magama.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Agama',
                    href: 'magama.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1907(){			
            ...
            if ($('#tt4').tabs('exists','M-Status Nikah')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'msnikah.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Status Nikah',
                    href: 'msnikah.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1909(){			
            ...
            if ($('#tt4').tabs('exists','M-Kewarganegaraan')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mkewarganegaraan.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Kewarganegaraan',
                    href: 'mkewarganegaraan.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1910(){			
            ...
            if ($('#tt4').tabs('exists','M-Golongan Darah')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mgdarah.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Golongan Darah',
                    href: 'mgdarah.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1911(){			
            ...
            if ($('#tt4').tabs('exists','M-Jenis DPLK')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mdplk.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Jenis DPLK',
                    href: 'mdplk.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1912(){			
            ...
            if ($('#tt4').tabs('exists','M-Suku')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'msuku.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Suku',
                    href: 'msuku.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1913(){			
            ...
            if ($('#tt4').tabs('exists','M-Jenis Alamat')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mjalamat.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Jenis Alamat',
                    href: 'mjalamat.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1914(){			
            ...
            if ($('#tt4').tabs('exists','M-Jenis Provinsi')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mprovinsi.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Jenis Provinsi',
                    href: 'mprovinsi.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1915(){			
            ...
            if ($('#tt4').tabs('exists','M-Kabupaten/Kota')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mkabkot.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Kabupaten/Kota',
                    href: 'mkabkot.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1916(){			
            ...
            if ($('#tt4').tabs('exists','M-Jenis Keluarga')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mjkeluarga.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Jenis Keluarga',
                    href: 'mjkeluarga.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1917(){			
            ...
            if ($('#tt4').tabs('exists','M-Pekerjaan')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mpekerjaan.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Pekerjaan',
                    href: 'mpekerjaan.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1918(){			
            ...
            if ($('#tt4').tabs('exists','M-PLN Group')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mplng.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-PLN Group',
                    href: 'mplng.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1919(){			
            ...
            if ($('#tt4').tabs('exists','M-Keterangan Pendidikan')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mkpend.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Keterangan Pendidikan',
                    href: 'mkpend.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1920(){			
            ...
            if ($('#tt4').tabs('exists','M-Jenis Pendidikan')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mjpend.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Jenis Pendidikan',
                    href: 'mjpend.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1921(){			
            ...
            if ($('#tt4').tabs('exists','M-Satuan Pendidikan')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mspend.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Satuan Pendidikan',
                    href: 'mspend.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1922(){			
            ...
            if ($('#tt4').tabs('exists','M-Grade')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mgrade.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Grade',
                    href: 'mgrade.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1923(){			
            ...
            if ($('#tt4').tabs('exists','M-Reason')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mreason.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Reason',
                    href: 'mreason.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1924(){			
            ...
            if ($('#tt4').tabs('exists','M-EE Group')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'meegroup.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-EE Group',
                    href: 'meegroup.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1925(){			
            ...
            if ($('#tt4').tabs('exists','M-EE Sub Group')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'meesubgroup.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-EE Sub Group',
                    href: 'meesubgroup.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1926(){			
            ...
            if ($('#tt4').tabs('exists','M-Company Code')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mccode.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Company Code',
                    href: 'mccode.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1927(){			
            ...
            if ($('#tt4').tabs('exists','M-Business Area')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mbarea.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Business Area',
                    href: 'mbarea.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1928(){			
            ...
            if ($('#tt4').tabs('exists','M-Posisi Kunci')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mposisikunci.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Posisi Kunci',
                    href: 'mposisikunci.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1929(){			
            ...
            if ($('#tt4').tabs('exists','M-Jenis Asuransi')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mjasuransi.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Jenis Asuransi',
                    href: 'mjasuransi.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1930(){			
            ...
            if ($('#tt4').tabs('exists','M-Keterangan Mutasi')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mkmutasi.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Keterangan Mutasi',
                    href: 'mkmutasi.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1931(){			
            ...
            if ($('#tt4').tabs('exists','M-Alasan Berhenti')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'maberhenti.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Alasan Berhenti',
                    href: 'maberhenti.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
        ...
        function addPanel1932(){			
            ...
            if ($('#tt4').tabs('exists','M-Jenjang Jabatan')){
                ...
                var tab = $('#tt4').tabs('getSelected');
                tab.panel('refresh', 'mjenjang.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
            } else {
                $('#tt4').tabs('add',{
                    title: 'M-Jenjang Jabatan',
                    href: 'mjenjang.php?proses=<?=$akses_proses;?>&view=<?=$akses_view;?>',
                    closable: true
                });
            }			
        }
