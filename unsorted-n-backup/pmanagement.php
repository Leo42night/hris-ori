...
if (!$userhris || ($akses_proses!="1" && $akses_view!="1")){
    ...
    <table id="dgpmanagement" title="" class="easyui-datagrid" style="width:100%;height:100%"	
            url="get_master_pmanagement.php" pageSize="20"        
    ...
    <script type="text/javascript">
    	...
    	function editpmanagement(index){
    		...
    		if (row){
                ...
                url = 'update_pmanagement.php?id='+row.idpmanagement;  
            }          
    	}
            ...
            $('#fmpmanagement').form('submit',{
                ...
                success: function(result){
                    ...
                    if (result.errorMsg){
                        ...
                        $.post('updatedata/update_pmanagement.php',{},function(result){},'json');
    	...
    	function destroypmanagement(index){
    		...
    		if (row){
    			$.messager.confirm('Konfirmasi','Yakin menghapus data ini?',function(r){
    				if (r){
    					$.post('destroy_pmanagement.php',{id:row.idpmanagement},function(result){
    						if (result.success){
    	...
    	function uploadtemplatepmanagement(){
    		...
    		url = 'save_templatepmanagement.php';
    	}
