...
if ($userhris){
    ...
    if($jumlahspt==0){
        ...
        while($hasil4 = mysqli_fetch_array($rs4)){
            ...
            $bonus_thr = $uang_cuti+$iks+$bonus+$honorarium_eo+$thr+$uang_winduan+$tantiem+$uang_pesangon;
            $tunjangan_pph = 0;
            ...
            $brutob = $gaji+$tunjangan_variable+$honorarium+$benefit2+$natuna+$beban_pph21;
            $biaya_jabatanb = 0;
            $iuran_pensiunb = 0;
