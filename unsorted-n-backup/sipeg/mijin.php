	...
	<script type="text/javascript">                     
        ...
        */
        function onSelectkelompokmijincari(){
            ...
            var url1 = 'get_spkmijincari.php?kelompok='+nilai1+'&kd_region='+nilai2+'&kd_cabang='+nilai3;
			/*
    ...
    <script type="text/javascript">
        ...
        function editmijin(index){
    		...
    		if (row){
                ...
                url = 'update_mijin.php?id='+row.idmijin;  
            }
        } 
    	function savemijin(){
        ...
        function cetakabsensi(){
            ...
            //window.open("lapmijin.php?tanggal="+tanggalnya+"&kelompok="+kelompoknya+"&kd_region="+kd_regionnya+"&kd_cabang="+kd_cabangnya+"&kd_unit="+kd_unitnya+"&nip_nama="+nip_namanya,"_blank");
            window.open("lapmijin.php?tanggal="+tanggalnya+"&kelompok="+kelompoknya+"&kd_region="+kd_regionnya+"&kd_cabang="+kd_cabangnya+"&kd_unit="+kd_unitnya+"&no_spk="+no_spknya,"_blank");
        } 
        ...
        function downloadabsensi(){
			...
			var no_spknya = $('#no_spkmijincari').textbox('getText');
            var tanggalnya = $('#tanggalmijincari').datebox('getValue');
            window.open("download_mijin.php?tanggal="+tanggalnya+"&kelompok="+kelompoknya+"&kd_region="+kd_regionnya+"&kd_cabang="+kd_cabangnya+"&kd_unit="+kd_unitnya+"&no_spk="+no_spknya,"_blank");
        } 
