...
if (!$userhris || ($akses_proses!="1" && $akses_view!="1")){
    ...
    <table id="dgmgaji" title="" class="easyui-datagrid" style="width:100%;height:100%"	
            url="<?=$foldernya;?>get_master_mgaji.php" pageSize="20"        
		...
		<thead data-options="frozen:true">
			<tr>
    			...
    			<th field="namamgaji" width="200" align="left" halign="left" data-options="styler:styler1">Nama Lengkap</th>                
			</tr>
		</thead>
    	<thead>
    		<tr>
                ...
                <th rowspan="2" field="tunjangan_posisimgaji" width="100" align="right" halign="center" data-options="formatter:formatrp2,styler:styler1">T.Posisi<br/>(P2-1A)</th>
                <th rowspan="2" field="p21bmgaji" width="100" align="right" halign="center" data-options="formatter:formatrp2,styler:styler1">T.Posisi<br/>(P2-1B)</th>
                <th rowspan="2" field="tunjangan_kemahalanmgaji" width="100" align="right" halign="center" data-options="formatter:formatrp2,styler:styler1">T.Lokasi</th>
    ...
    <div id="toolbarmgaji" style="background-color:#fff;padding:5px;">
        ...
        <a target="_blank" href="sipeg/template/template_mgaji.xlsx" class="easyui-linkbutton c6" iconCls="fa fa-plus-circle" plain="false" style="min-width:90px;">Template mgaji</a>
        <a href="javascript:void(0)" class="easyui-linkbutton c1" iconCls="fa fa-plus-circle" plain="false" onclick="uploadtemplatemgaji()" style="min-width:90px;">Upload Template</a>     
        <?php } ?>
    </div>
    
    <div id="dlgtemplatemgaji" class="easyui-dialog" modal="true" style="min-width:300px;min-height:80px;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:20px;"
    		closed="true" buttons="#dlg-buttonstemplatemgaji">
    	<form id="fmtemplatemgaji" class="easyui-form" method="post" data-options="novalidate:true" enctype="multipart/form-data">
            <table>
                <tr>
                    <td style="white-space:nowrap;">Template Gaji</td>                    
                    <td>
            			<input class="easyui-filebox" id="file_templatemgaji" name="file_templatemgaji" buttonAlign="left" buttonText="Upload Excel" editable="false" data-options="required:true,prompt:'Format file excel...'" style="width:400px">
                    </td>
                </tr>
            </table>
    	</form>
    </div>
    <div id="dlg-buttonstemplatemgaji">        
        <a href="javascript:void(0)" id="simpan" class="easyui-linkbutton c1" iconCls="fa fa-save" onclick="savetemplatemgaji()" style="min-width:90px">Upload</a>
        <a href="javascript:void(0)" class="easyui-linkbutton c5" iconCls="fa fa-times-circle" onclick="javascript:$('#dlgtemplatemgaji').dialog('close')" style="min-width:90px">Batal</a>
    </div>
    
    <div id="dlgmgaji" class="easyui-dialog" modal="true" style="min-width:200px;min-height:120px;max-height:500px;padding:10px;top:50px;"
    	...
    	<form id="fmmgaji" class="easyui-form" method="post" data-options="novalidate:true" enctype="multipart/form-data">
            ...
            <tr>
                ...
                <td colspan="4"><input class="easyui-textbox" id="nipmgaji" name="nipmgaji" missingMessage="Harus di isi" data-options="required:true" style="width: 150px;" readonly></td>
            </tr>  
            <tr>
                <td style="width:100px;">Nama</td>
                <td colspan="4">
                    <input class="easyui-textbox" id="namamgaji" name="namamgaji" data-options="required:true" style="width: 460px;" readonly>
                </td>
            </tr>  
            <tr>
            ...
            <tr>
                ...
                <td></td>
                <td>Pot.Bazis</td>
                <td><input class="easyui-numberbox" id="pot_bazismgaji" name="pot_bazismgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:1,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
            </tr>              
            <tr>
                <td>Honorer</td>
            ...
            <tr>
                <td>Tunj.Posisi (P2-1B)</td>
                <td><input class="easyui-numberbox" id="p21bmgaji" name="p21bmgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:0,groupSeparator:',',decimalSeparator:'.'" style="width: 150px;"></td>
                <td></td>
                <td>BRPR</td>
            ...
            <tr>
                <td>Tunj.Perumahan</td>
                <td><input class="easyui-numberbox" id="tunjangan_perumahanmgaji" name="tunjangan_perumahanmgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:0,groupSeparator:',',decimalSeparator:'.'" style="width: 150px;"></td>
                <td></td>
                <td>Pot.Qurban</td>
            ...
            <tr>
                ...
                <td></td>
                <td>DPLK Pegawai</td>
                <td><input class="easyui-numberbox" id="dplk_simponimgaji" name="dplk_simponimgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
            </tr>
            <tr>
                <td>Tunj.Kompetensi</td>
                <td><input class="easyui-numberbox" id="tunjangan_kompetensimgaji" name="tunjangan_kompetensimgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:0,groupSeparator:',',decimalSeparator:'.'" style="width: 150px;"></td>
                <td></td>
                <td>DPLK Pribadi</td>
            ...
            <tr>
                <td>DPLK Perushn</td>
                <td><input class="easyui-numberbox" id="dplk_simponi_prmgaji" name="dplk_simponi_prmgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
                <td></td>
            </tr>
            <tr>
                <td>BPJS Kes Persh</td>
                <td><input class="easyui-numberbox" id="bpjs_kes_ppmgaji" name="bpjs_kes_ppmgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
                <td></td>
                <td>BPJS Kes Peg</td>
                <td><input class="easyui-numberbox" id="bpjs_kes_pkmgaji" name="bpjs_kes_pkmgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
            </tr>
            <tr>
                <td>JKM Perusahaan</td>
                <td><input class="easyui-numberbox" id="bpjs_tk_kpmgaji" name="bpjs_tk_kpmgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
                <td></td>
                <td>JP Pegawai</td>
                <td><input class="easyui-numberbox" id="bpjs_tk_pkmgaji" name="bpjs_tk_pkmgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
            </tr>
            <tr>
                <td style="text-align:right;padding-right:5px;font-size:11px;color:#0062c2;">(Rp)</td>
            ...
            <tr>
                ...
                <td><input class="easyui-numberbox" id="bpjs_tk_kkpmgaji" name="bpjs_tk_kkpmgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
                <td></td>
                <td>JHT Pegawai</td>
                <td><input class="easyui-numberbox" id="bpjs_tk_jhtkmgaji" name="bpjs_tk_jhtkmgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
            </tr>
            <tr>
                <td style="text-align:right;padding-right:5px;font-size:11px;color:#0062c2;">(Rp)</td>
            ...
            <tr>
                <td>JP Perusahaan</td>
                <td><input class="easyui-numberbox" id="bpjs_tk_ppmgaji" name="bpjs_tk_ppmgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
                <td></td>
                <td>Potongan Lainnya</td>
                <td><input class="easyui-textbox" id="nama_potongan1mgaji" name="nama_potongan1mgaji" missingMessage="Harus di isi" data-options="required:false,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
            </tr>
            <tr>
                <td style="text-align:right;padding-right:5px;font-size:11px;color:#0062c2;">(Rp)</td>
                ...
                <td></td>
                <td style="text-align:right;padding-right:5px;font-size:11px;color:#0062c2;">(Rp)</td>
                <td><input class="easyui-numberbox" id="potongan1mgaji" name="potongan1mgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:0,groupSeparator:',',decimalSeparator:'.'" style="width: 150px;"></td>
            </tr>
            <tr>
                <td>JHT Perusahaan</td>
                <td><input class="easyui-numberbox" id="bpjs_tk_htpmgaji" name="bpjs_tk_htpmgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
                <td></td>
                <td>Potongan Lainnya</td>
                <td><input class="easyui-textbox" id="nama_potongan2mgaji" name="nama_potongan2mgaji" missingMessage="Harus di isi" data-options="required:false,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
            </tr>
            <tr>
                <td style="text-align:right;padding-right:5px;font-size:11px;color:#0062c2;">(Rp)</td>
                ...
                <td></td>
                <td style="text-align:right;padding-right:5px;font-size:11px;color:#0062c2;">(Rp)</td>
                <td><input class="easyui-numberbox" id="potongan2mgaji" name="potongan2mgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:0,groupSeparator:',',decimalSeparator:'.'" style="width: 150px;"></td>
            </tr>
            <!--
            <tr>
                <td>Tunjangan Lainnya</td>
                <td><input class="easyui-textbox" id="nama_tunjangan1mgaji" name="nama_tunjangan1mgaji" missingMessage="Harus di isi" data-options="required:false,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
                <td></td>
                <td>Potongan Lainnya</td>
                <td><input class="easyui-textbox" id="nama_potongan1mgaji" name="nama_potongan1mgaji" missingMessage="Harus di isi" data-options="required:false,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
            </tr>
            <tr>
                <td style="text-align:right;padding-right:5px;font-size:11px;color:#0062c2;">(Rp)</td>
                <td><input class="easyui-numberbox" id="tunjangan1mgaji" name="tunjangan1mgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:0,groupSeparator:',',decimalSeparator:'.'" style="width: 150px;"></td>
                <td></td>
                <td style="text-align:right;padding-right:5px;font-size:11px;color:#0062c2;">(Rp)</td>
                <td><input class="easyui-numberbox" id="potongan1mgaji" name="potongan1mgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:0,groupSeparator:',',decimalSeparator:'.'" style="width: 150px;"></td>
            </tr>
            <tr>
                <td>Tunjangan Lainnya</td>
                <td><input class="easyui-textbox" id="nama_tunjangan2mgaji" name="nama_tunjangan2mgaji" missingMessage="Harus di isi" data-options="required:false,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
                <td></td>
                <td>Potongan Lainnya</td>
                <td><input class="easyui-textbox" id="nama_potongan2mgaji" name="nama_potongan2mgaji" missingMessage="Harus di isi" data-options="required:false,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
            </tr>
            <tr>
                <td style="text-align:right;padding-right:5px;font-size:11px;color:#0062c2;">(Rp)</td>
                <td><input class="easyui-numberbox" id="tunjangan2mgaji" name="tunjangan2mgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:0,groupSeparator:',',decimalSeparator:'.'" style="width: 150px;"></td>
                <td></td>
                <td style="text-align:right;padding-right:5px;font-size:11px;color:#0062c2;">(Rp)</td>
                <td><input class="easyui-numberbox" id="potongan2mgaji" name="potongan2mgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:0,groupSeparator:',',decimalSeparator:'.'" style="width: 150px;"></td>
            </tr>
            <tr>
                <td>Tunjangan Lainnya</td>
                <td><input class="easyui-textbox" id="nama_tunjangan3mgaji" name="nama_tunjangan3mgaji" missingMessage="Harus di isi" data-options="required:false,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
                <td></td>
                <td>Potongan Lainnya</td>
                <td><input class="easyui-textbox" id="nama_potongan3mgaji" name="nama_potongan3mgaji" missingMessage="Harus di isi" data-options="required:false,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
            </tr>
            <tr>
                <td style="text-align:right;padding-right:5px;font-size:11px;color:#0062c2;">(Rp)</td>
                <td><input class="easyui-numberbox" id="tunjangan3mgaji" name="tunjangan3mgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:0,groupSeparator:',',decimalSeparator:'.'" style="width: 150px;"></td>
                <td></td>
                <td style="text-align:right;padding-right:5px;font-size:11px;color:#0062c2;">(Rp)</td>
                <td><input class="easyui-numberbox" id="potongan3mgaji" name="potongan3mgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:0,groupSeparator:',',decimalSeparator:'.'" style="width: 150px;"></td>
            </tr>
            <tr>
                <td>Tunjangan Lainnya</td>
                <td><input class="easyui-textbox" id="nama_tunjangan4mgaji" name="nama_tunjangan4mgaji" missingMessage="Harus di isi" data-options="required:false,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
                <td></td>
                <td>Potongan Lainnya</td>
                <td><input class="easyui-textbox" id="nama_potongan4mgaji" name="nama_potongan4mgaji" missingMessage="Harus di isi" data-options="required:false,min:0,precision:2,groupSeparator:',',decimalSeparator:'.',suffix:'%'" style="width: 150px;"></td>
            </tr>
            <tr>
                <td style="text-align:right;padding-right:5px;font-size:11px;color:#0062c2;">(Rp)</td>
                <td><input class="easyui-numberbox" id="tunjangan4mgaji" name="tunjangan4mgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:0,groupSeparator:',',decimalSeparator:'.'" style="width: 150px;"></td>
                <td></td>
                <td style="text-align:right;padding-right:5px;font-size:11px;color:#0062c2;">(Rp)</td>
                <td><input class="easyui-numberbox" id="potongan4mgaji" name="potongan4mgaji" missingMessage="Harus di isi" data-options="required:true,min:0,precision:0,groupSeparator:',',decimalSeparator:'.'" style="width: 150px;"></td>
            </tr>
            -->
            </table>
    	</form>
    ...
    <script type="text/javascript">
    	...
    	function editmgaji(index){
    		...
    		if (row){
                ...
                url = '<?=$foldernya;?>update_mgaji.php?id='+row.idmgaji;  
            }          
    	}
    	function savemgaji(){
            //var p21b = $("#p21bmgaji").numberbox('getValue');
            //alert(p21b);
    	...
    	function destroymgaji(index){
    		...
    		if (row){
    			$.messager.confirm('Konfirmasi','Yakin menghapus data mgaji "'+row.nama_lengkapmgaji+'"?',function(r){
    				if (r){
    					$.post('<?=$foldernya;?>destroy_mgaji.php',{id:row.idmgaji},function(result){
    						if (result.success){
    	...
    	function uploadtemplatemgaji(){
    		$('#dlgtemplatemgaji').dialog('open').dialog('setTitle','Upoad Template Gaji');
            $('#fmtemplatemgaji').form('clear');
    		url = '<?=$foldernya;?>save_templatemgaji.php';
    	}
    	function savetemplatemgaji(){
            $.messager.progress({height:75, text:'Proses import Data'});
    		$('#fmtemplatemgaji').form('submit',{
    			url: url,
    			onSubmit: function(){
                    //return $(this).form('enableValidation').form('validate');
                    var v=$(this).form('validate');
    	...
    	function detailmgaji(index){
    		...
    		if (row){
                if ($('#tt').tabs('exists','Riwayat mgaji')){
                    ...
                    tab.panel('refresh', '<?=$foldernya;?>mgaji2.php?nip='+row.nipmgaji+'&proses=<?=$akses_proses;?>&view=<?=$akses_view;?>');
                } else {
                    $('#tt').tabs('add',{
                        title: 'Riwayat mgaji',
