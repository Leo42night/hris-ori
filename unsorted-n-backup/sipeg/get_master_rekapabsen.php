...
if ($userhris){
    ...
    $blth_ini = date("Y-m");    
    $blth2 = isset($_POST['blthrekapabsencari']) ? $_POST['blthrekapabsencari'] : date("Y-m");
    $nama2 = isset($_POST['namarekapabsencari']) ? $_POST['namarekapabsencari'] : "";
    $tgl_awal = $blth2."-01";
    ...
    while ($hasil2 = mysqli_fetch_array($rs2)) {
        ...
        */    
        ...
        $datanya = array();
        $datanya["blthrekapabsen"] = $blth2;
        $datanya["niprekapabsen"] = $nip;
        $datanya["namarekapabsen"] = $nama;
        $datanya["jabatanrekapabsen"] = $jabatan;
        $datanya["jumlah_masukrekapabsen"] = $jumlah_masuk;
        $datanya["jumlah_pulangrekapabsen"] = $jumlah_pulang;
        $datanya["jumlah_sppdrekapabsen"] = $jumlah_sppd;
        $datanya["jumlah_cutirekapabsen"] = $jumlah_cuti;
